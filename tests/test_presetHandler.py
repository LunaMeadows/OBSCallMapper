import jsonschema
import pytest
from mappingUtils import presethandler


def test_loadJson_is_file_false():
    ph = presethandler.PresetHandler()
...
def test_loadJson_is_file_true():
    ...
    # assert ph.load_json('newPresets.json') == "File provided does not exist. Please create new presets.json with create_presets or check file given is correct"
